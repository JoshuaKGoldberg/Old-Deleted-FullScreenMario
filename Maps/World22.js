...
map.areas = [
  ...
  new Area("Underwater", function() {
    ...
    pushPreThing(GenericStone, 520, 24, 1, 3);
    pushPreThing(GenericStone, 528, 40, 1, 5);
    fillPreThing(Coin, 546, 23, 3, 1, 8);
    
    pushPreFloor(576, 0, 60);
    pushPreThing(GenericStone, 576, 40, 1, 5);
    pushPreThing(GenericStone, 584, 24, 1, 3);
    pushPreThing(CheepCheep, 616, 24, false, false);
    pushPreThing(GenericStone, 632, 24, 2, 3);
    pushPreThing(GenericStone, 632, 88, 2, 3);
    pushPreThing(CheepCheep, 640, 48, false, false);
    pushPreThing(CheepCheep, 656, 16, false, false);
    pushPreThing(GenericStone, 664, 64, 3, 1);
    ...
    pushPreThing(GenericStone, 1128, 16, 1, 2);
    pushPreThing(GenericStone, 1136, 32, 1, 4);
    ...
    pushPreThing(GenericStone, 1256, 64, 1, 8);
    pushPreThing(GenericStone, 1264, 64, 2, 1);
    fillPreThing(Coin, 1281, 32, 3, 2, 8, -24);
    pushPreThing(GenericStone, 1304, 64, 2, 1);
    pushPreFloor(1320, 0, 40);
    pushPreThing(GenericStone, 1320, 64, 1, 8);
    pushPreThing(CheepCheep, 1320, 80, false, false);
    pushPreThing(CheepCheep, 1344, 16, true, false);
    fillPreThing(GenericStone, 1384, 32, 1, 2, 0, 32, 5, 1);
    pushPreThing(Coral, 1392, 80, 2);
    pushPreThing(CheepCheep, 1408, 40, false, false);
    fillPreThing(GenericStone, 1448, 32, 1, 2, 0, 32, 4, 1);
    pushPreThing(CheepCheep, 1472, 72, true, false);
    pushPreThing(CheepCheep, 1496, 48, true, false);
    
    pushPreThing(GenericStone, 1488, 8, 5, 1);
    pushPreThing(GenericStone, 1496, 16, 4, 1);
    pushPreThing(GenericStone, 1504, 24, 3, 1);
    pushPreThing(GenericStone, 1512, 32, 2, 1);
    pushPreThing(GenericStone, 1512, 88, 2, 4);
    pushPreThing(PipeSide, 1520, 48, 2);
    pushPreThing(GenericStone, 1528, 88, 14, 11);
  }),
  new Area("Overworld", function() {
