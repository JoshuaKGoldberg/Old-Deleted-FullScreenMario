...
map.areas = [
  new Area("Overworld Alt", function() {
    ...
    pushPreThing(GenericStone, 712, 24, 1, 3);
    pushPreThing(GenericStone, 712, 32, 5);
    ...
    pushPreThing(GenericStone, 928, 24, 1, 3);
    ...
    pushPreThing(GenericStone, 1456, 8);
    ...
    pushPreThing(GenericStone, 1512, 64, 2, 7);
    endCastleOutside(1588, 0, castlev);
  }),
